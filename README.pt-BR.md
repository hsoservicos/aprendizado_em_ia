...
| RTK | >= 0.47 | Compressão de tokens (opcional) |
| ripgrep | >= 14.0 | Busca rápida (recomendado) |
...
├── .claude/skills/          # 57 skills BMAD (espelho)
...
| Registro de Ferramentas | `_bmad-output/tools-registry.md` | Inventário de ferramentas (v1.2.0) |
